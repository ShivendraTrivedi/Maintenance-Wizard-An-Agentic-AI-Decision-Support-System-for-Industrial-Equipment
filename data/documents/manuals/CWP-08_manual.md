# Equipment Manual — Cooling Water Pump (CWP-08)
...
## 1. Overview
The Cooling Water Pump (CWP-08) is a medium-criticality asset in the Utilities area. This manual describes its monitored parameters, normal operating envelope, common fault modes, recommended maintenance schedule, troubleshooting guidance, and associated spare parts.
