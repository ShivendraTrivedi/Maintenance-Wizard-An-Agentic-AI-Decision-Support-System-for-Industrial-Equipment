# Failure Analysis Report — CCM-OSC-01 — FR-20241219-001

**Asset:** CCM-OSC-01 (Continuous Casting Mould Oscillator)  
**Area:** Continuous Casting  
**Date of failure:** 2024-12-19  
**Downtime:** 12 hours  
**Fault mode:** Servo valve sticking  

## Event Description
Operations reported an abnormal condition on CCM-OSC-01. Valve hysteresis degrades oscillation waveform fidelity. The parameter 'mould_level_dev' deviated from its normal band (-5–5 mm) prior to the trip.
