# Failure Analysis Report — CCM-OSC-02 — FR-20250314-004

**Asset:** CCM-OSC-02 (Continuous Casting Mould Oscillator)  
**Area:** Continuous Casting  
**Date of failure:** 2025-03-14  
**Downtime:** 8 hours  
**Fault mode:** Hydraulic pressure loss  

## Event Description
Operations reported an abnormal condition on CCM-OSC-02. Internal leakage reduces oscillation stroke, risking sticker breakouts. The parameter 'mould_level_dev' deviated from its normal band (-5–5 mm) prior to the trip.
